...
class Addressbook{
	 ...
	 */
	function addPhonesToAddressBook($idAddressBook, $data){
		$data = json_encode($data);
		return $this->gateway->execCommad('addPhoneToAddressBook', array('idAddressBook'=>$idAddressBook, 'data'=>$data));
	}
	/**
	...
	/**
	 * Add variable to address book
	 */
	function addAddressBookVariable($idAddressBook, $varType, $varName) {
		return $this->gateway->execCommad('addAddressBookVariable',array('idAddressBook'=>$idAddressBook, 'varType'=>$varType, 'varName'=>$varName));
	}

	/**
	 * Get all variables from address book
	 */
	function getAllAddressBookVariables($idAddressBook) {
		return $this->gateway->execCommad('getAllAddressBookVariables',array('idAddressBook'=>$idAddressBook));
	}

	/**
	 * Edit variable in address book
	 */
	function editAddressBookVariable($idAddressBook, $idVar, $valueVar) {
		return $this->gateway->execCommad('editAddressBookVariable',array('idAddressBook'=>$idAddressBook, 'varId'=>$idVar, 'varName'=>$valueVar));
	}

	/**
	 * delete variable from address book
	 */
	function delAddressBookVariable($idAddressBook, $idVar) {
		return $this->gateway->execCommad('delAddressBookVariable',array('idAddressBook'=>$idAddressBook, 'varId'=>$idVar));
	}
